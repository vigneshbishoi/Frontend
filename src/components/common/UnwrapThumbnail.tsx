...
interface UnwrapThumbnailProps {
  visible: boolean;
...
let dynamicPopupData = [
  ...
  {
    btn: 'Continue',
    image: images.main.thumbnailstageTwo,
    mainHeading: 'Thumbnail',
    subHeading: 'Add some flavor to your taggs with your own thumbnail!',
  },
  {
    btn: 'Done',
    image: images.main.thumbnailstagethree,
    mainHeading: 'Check it out',
    subHeading: 'Edit a tagg to try it out!',
  },
];
let count = 0;
const UnwrapThumbnail: React.FC<UnwrapThumbnailProps> = ({ visible, setVisible, setCount }) => {
...
export default UnwrapThumbnail;
