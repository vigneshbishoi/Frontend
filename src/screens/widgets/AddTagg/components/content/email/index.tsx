...
export const EmailLinkContent: React.FC<ContentType> = ({
  constructor,
  url,
  tmb,
  tmbb,
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} style={styles.bottomBlock}>
      <Text style={[styles.title, styles.smallBottom]}>Email</Text>
      <Text style={[styles.subTitle]}>Add your email address</Text>
      ...
      <LockedModal
        ...
        message={score >= 250 ? 'Tagg Font Color' : ''}
